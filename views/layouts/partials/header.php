            ...
            <div class="container">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1><a class="main__logo--link" href="<?= BASE_URL ?>">Volcano Pizza</a></h1>
                    </div>
                    <div class="header__menu d-none d-lg-block">
                        <?php require_once PATH_VIEW . 'layouts/partials/breadcrumb.php'?>
                    </div>
                    <div class="header__account">
                    <?php require_once PATH_VIEW . 'layouts/partials/toggle.php'?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.html">
                        <img src="<?= BASE_URL ?>assets/client/assets/img/logo/nav-log.png" alt="Grocee Logo" width="158" height="36">
                    </a>
                ...
                <nav class="offcanvas__menu">
                    ...
                    <div class="offcanvas__account--currency">
                        <a class="offcanvas__account--currency__menu text-black" href="javascript:void(0)">
                            <img src="<?= BASE_URL ?>assets/client/assets/img/icon/usd-icon.png" alt="currency">
                            <span>USD</span> 
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="<?= BASE_URL ?>assets/client/assets/img/product/product1.png" alt="prduct-img"></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="<?= BASE_URL ?>assets/client/assets/img/product/product2.png" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
