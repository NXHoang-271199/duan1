                ...
                <div class="row">
                    <div class="col-md-6">
                        <!-- <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="name" value="" placeholder="Enter name" name="username">
                        </div> -->
                        <div class="mb-3 mt-3">
                    ...
                    <div class="col-md-6">
                        <!-- <div class="mb-3 mt-3">
                            ...
                            <input type="file" class="form-control" id="image" placeholder="Enter avatar" name="image">
                        </div> -->
                        <div class="mb-3 mt-3">
